...
# Append the content of Task contract/contracterc20tx.txt to erc20.txt
cat "Task contract/contracterc20tx.txt" >> "Task contract/contracterc20.txt"

# Append the content of Task contract/contracterc721.txt to erc20.txt
cat "Task contract/contracterc721.txt" >> "Task contract/contracterc20.txt"

# Append the content of Task contract/contracterc721tx.txt to erc20.txt
...
# Append the content of Task contract/contractperc20tx.txt to erc20.txt
cat "Task contract/contractperc20tx.txt" >> "Task contract/contracterc20.txt"

# Append the content of Task contract/contractprivate.txt to erc20.txt
...
cat "Task contract/contractproxyaddress1.txt" >> "Task contract/contracterc20.txt"
...
# Append the content of Task contract/erc20tx.txt to erc20.txt
cat "Task contract/contractproxyaddress2.txt" >> "Task contract/contracterc20.txt"

# Append the content of Task contract/erc20tx.txt to erc20.txt
cat "Task contract/contractproxy.txt" >> "Task contract/contracterc20.txt"

# Append the content of Task contract/erc20tx.txt to erc20.txt
cat "Task contract/contracterc20.txt" >> "Task contract/full.txt"

# Append the content of Task contract/erc20tx.txt to erc20.txt
echo "" >> "Task contract/full.txt"
